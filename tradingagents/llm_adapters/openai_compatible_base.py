        ...
        **kwargs
        ...
        if not qianfan_api_key:
            raise ValueError(
                ...
                "格式为: bce-v3/<your-qianfan-key>"
            )

        if not qianfan_api_key.startswith('bce-v3/'):
            raise ValueError(
                "QIANFAN_API_KEY格式错误，应为: bce-v3/<your-qianfan-key>"
            )
    ...
    for provider, info in OPENAI_COMPATIBLE_PROVIDERS.items():
        ...
        try:
            if provider == "custom_openai":
                ...
                # 千帆新一代API仅需QIANFAN_API_KEY，格式: bce-v3/<your-qianfan-key>
                cls(model="ernie-3.5-8k", api_key="bce-v3/<your-qianfan-key>")
            else:
