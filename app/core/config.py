...
class Settings(BaseSettings):
    ...
    MARKET_INTELLIGENCE_INJECT_TO_ANALYSIS: bool = Field(default=True)
    MARKET_INTELLIGENCE_FORCE_NEWS_SOCIAL_ANALYSTS: bool = Field(default=True)
    MARKET_INTELLIGENCE_ANALYSIS_REFRESH_MAX_AGE_MINUTES: int = Field(default=15, ge=1, le=180)
    MARKET_INTELLIGENCE_ANALYSIS_EVIDENCE_HOURS: int = Field(default=36, ge=1, le=168)
